...
public class InstructionTester {
	...
	@Test
	// Test whether or not the FOR instruction is correct with immediate addressing
	public void testFORI() {
		...
		machine.setCode(0,0);
		machine.setCode(0,0);
		machine.setCode(0x2 * 8 + 1, 1);
		machine.setCode(0x5 * 8 + 1 + 2, 1);
		machine.setCode(0x2 * 8 + 4, 1);
		machine.setCode(0xF * 8, 0);
		
		machine.setData(0, 0x3005);
		machine.setData(1, 0x1);
		machine.setData(2, 0x3);
	...
	@Test
	// Test whether or not the FOR instruction is correct with direct addressing
	public void testFOR() {		
		Instruction instr = machine.get(0xD);
